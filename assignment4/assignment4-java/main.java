...
public class main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("NN total cost: " + Utility.calculateTotalCost(nnSol, instance));
        nnSol.setTotalCost(Utility.calculateTotalCost(nnSol, instance));

        VRPSolution svSol = Utility.savingsHeuristic(instance);
        System.out.println("Saving total cost: " + Utility.calculateTotalCost(svSol, instance));
